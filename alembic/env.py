"""
Alembic environment configuration for GVD-FRS project.
This configuration uses the sync database connection for migrations.
"""
import asyncio
import os
import sys
...
def get_database_url():
    ...
    Uses DATABASE_TEST_URL if in testing mode, otherwise DATABASE_SYNC_URL.
    """
